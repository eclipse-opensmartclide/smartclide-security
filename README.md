...
```
cd existing_repo
git remote add origin https://iti-gitlab.iti.gr/smartclide/security.git
git branch -M main
...
- [ ] [Set up project integrations](https://iti-gitlab.iti.gr/smartclide/security/-/settings/integrations)
